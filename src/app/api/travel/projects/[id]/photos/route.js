...
export async function POST(req, { params }) {
  try {
    ...
    // Optional: user-supplied receipt date (YYYY-MM-DD). If blank, we default to uploadedAt later.
    const receiptDateRaw = String(fd.get("receiptDate") || "").trim();
    const receiptDate = isValidYMD(receiptDateRaw) ? receiptDateRaw : "";
    ...
    photos.push({
      ...
      // optional user-entered receipt date (YYYY-MM-DD)
      receiptDate,
    });
